...
function finalizeShutdown(app, workers) {
...
var HttpWorkerGroup = /** @class */ (function () {
    function HttpWorkerGroup(workers, workerServer) {
        var _this = this;
    ...
    HttpWorkerGroup.prototype.addWorker = function (worker) {
        worker.group = this;
    ...
    HttpWorkerGroup.prototype.removeWorker = function (worker) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, worker.cleanup()];
                    case 1:
                        _a.sent();
    ...
    HttpWorkerGroup.prototype.startShutdown = function () {
        return __awaiter(this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, finalizeShutdown(this.server, this.workers)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
...
exports.default = HttpWorkerGroup;
//# sourceMappingURL=HttpWorkerGroup.js.map