...
function checkWorkersReadyForExit(app, workers, killTimeout) {
    return __awaiter(this, void 0, void 0, function () {
        var doExit, _i, workers_1, worker, _a, workers_2, worker;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!doExit) return [3 /*break*/, 5];
                    _a = 0, workers_2 = workers;
                    _b.label = 1;
                case 1:
                    if (!(_a < workers_2.length)) return [3 /*break*/, 4];
                    worker = workers_2[_a];
