...
var Worker = /** @class */ (function () {
    function Worker() {
        ...
        this.lock = new async_lock_1.default({ maxPending: 1 });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        this.workInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                            var error_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
    ...
    Worker.prototype.doWork = function () {
        return __awaiter(this, void 0, void 0, function () {
            var restart, lockError_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.lock.acquire(this.id, function () { return __awaiter(_this, void 0, void 0, function () {
                                var acquireResponse, executeResponse_1, restart_1, error_3;
                                var _this = this;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                    ...
                    case 2:
                        lockError_1 = _a.sent();
                        console.warn('lock error', lockError_1);
                        return [2 /*return*/, false];
