...
var WorkerA = /** @class */ (function (_super) {
    ...
    function WorkerA() {
        ...
        _this.name = "Worker A";
        _this.channel = "worker_a";
        return _this;
    }
    WorkerA.prototype.executeTask = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(data && data.throw)) return [3 /*break*/, 1];
                        throw new Error(data.throw);
                    case 1: return [4 /*yield*/, new Promise(function (resolve, reject) { setTimeout(resolve, 10000); })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, { output: { "message": "Worker A did it!", "at": new Date() + '' } }];
                }
            });
        });
    };
...
exports.default = WorkerA;
//# sourceMappingURL=WorkerA.js.map